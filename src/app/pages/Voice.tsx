...
import { Mic, MicOff, Volume2, VolumeX, Sparkles, Phone, PhoneOff, Settings, Waveform, ChevronRight } from 'lucide-react';

const voices = [
  { id: 'alloy', name: 'Alloy', desc: 'Neutral, balanced', sample: '▶', gender: 'Neutral' },
  { id: 'echo', name: 'Echo', desc: 'Deep, authoritative', sample: '▶', gender: 'Male' },
  { id: 'fable', name: 'Fable', desc: 'Warm, expressive', sample: '▶', gender: 'Male' },
  { id: 'onyx', name: 'Onyx', desc: 'Strong, confident', sample: '▶', gender: 'Male' },
  { id: 'nova', name: 'Nova', desc: 'Bright, energetic', sample: '▶', gender: 'Female' },
  { id: 'shimmer', name: 'Shimmer', desc: 'Soft, friendly', sample: '▶', gender: 'Female' },
];
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center">
          <p className="text-[15px] font-semibold text-[#0F172A]">
            {active ? 'Listening…' : 'Tap to start'}
          </p>
          <p className="text-[13px] text-[#94A3B8] mt-0.5">
            {active ? 'Speak clearly into your microphone' : 'Click the orb to begin voice conversation'}
          </p>
        </div>
